...
<body>
    <div class='container'>
      ...
      public async Task<bool> SendContactEmailAsync2(ContactFormModel model)
        {
            try
            {
                var message = new MimeMessage();
                ...
                // Destinataire (l'email de COOSSI qui recevra les demandes)
                var toAddress = _configuration["EmailSettings:ToAddress"] ?? "contact@coossi.fr";
        ...
        private string GenerateEmailBody2(ContactFormModel model)
        {
            return $@"
<!DOCTYPE html>
<html>
